...
export const heartMappingDatingTrack: Track = {
  id: "hm-dating",
  name: "HeartMapping Dating",
  description: "Pentru persoane singure care caută o relație",
  products: [
    {
...
export const heartMappingRelatiiTrack: Track = {
  id: "hm-relatii",
  name: "HeartMapping Relații Împlinitoare",
  description: "Pentru persoane aflate deja într-o relație",
  products: [
    {
...
export const individualSessions: Product[] = [
  {
...
export const allProducts: Product[] = [
  ...heartMappingDatingTrack.products,
  ...heartMappingRelatiiTrack.products,
  ...individualSessions,
];
